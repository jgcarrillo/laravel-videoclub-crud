...
class DatabaseSeeder extends Seeder
{
    ...
    private function seedCatalog(){
        ...
        foreach($this->arrayPeliculas as $pelicula){
            // Nueva instancia del modelo Movie
            $peli = new Movie;

            // Rellenamos cada columna con lo que hay dentro de cada película
    ...
    public function run()
    {
        // Transforma cada elemento del array en una nueva película
        // Ejecuta la funcion al hacer php artisan db:seed
        $this->seedCatalog();
